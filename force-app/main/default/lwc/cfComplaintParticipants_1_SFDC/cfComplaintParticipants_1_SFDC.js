import { FlexCardMixin } from "omnistudio/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "omnistudio/flexCardUtility";
          ...
          export default class cfComplaintParticipants_1_SFDC extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              @api debug;
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfComplaintParticipants_1_SFDC';
        ...
        this.pubsubEvent[0] = {
          pc_participants_selection_changed: this.handleEventAction.bind(this, data.events[0],0)
        };

        pubsub.register(`rowSelection`,this.pubsubEvent[0]);

              }

              unregisterEvents(){
                pubsub.unregister(`rowSelection`,this.pubsubEvent[0]);

import { FlexCardMixin } from "omnistudio/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "omnistudio/flexCardUtility";
          ...
          export default class cfSearchParticipants_1_SFDC extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              @api debug;
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfSearchParticipants_1_SFDC';
        ...
        this.pubsubEvent[0] = {
          selection_changed: this.handleEventAction.bind(this, data.events[0],0)
        };

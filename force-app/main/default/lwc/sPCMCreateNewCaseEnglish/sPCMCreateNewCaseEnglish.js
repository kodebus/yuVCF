...
import { OMNIDEF } from './sPCMCreateNewCaseEnglish_def.js';
import tmpl from './sPCMCreateNewCaseEnglish.html';
import tmpl_nds from './sPCMCreateNewCaseEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class sPCMCreateNewCaseEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
